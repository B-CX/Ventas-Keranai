...
export default function CalculatorWidget() {
  ...
  const calculatorPopover = (
    <div 
      ...
      className={`fixed w-72 rounded-3xl border border-white/10 bg-white/90 dark:bg-[#12121a]/95 p-4 shadow-2xl backdrop-blur-xl z-[100] ${isDragging ? 'cursor-grabbing opacity-90' : 'animate-fade-in'}`}
    >
      {/* Header Handle */}
      <div 
