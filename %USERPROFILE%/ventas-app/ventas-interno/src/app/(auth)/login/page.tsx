      ...
      <div className="z-10 w-full max-w-md rounded-2xl border border-white/10 bg-white/[0.03] p-8 shadow-2xl backdrop-blur-xl sm:p-10">
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-white/10 bg-white/[0.05] px-4 py-3 text-sm text-white placeholder-zinc-500 outline-none transition duration-200 focus:border-violet-500 focus:bg-white/[0.08] focus:ring-2 focus:ring-violet-500/20"
              />
            </div>
          ...
          <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink mx-4 text-zinc-500 text-xs uppercase font-medium">O bien</span>
            <div className="flex-grow border-t border-white/10"></div>
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/[0.02] px-4 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:bg-white/[0.06] active:scale-[0.98]"
          >
